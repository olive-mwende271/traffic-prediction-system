...
MODEL_FILES = [
    ...
    'scaler_ctx.pkl', 'feature_columns.pkl', 'context_columns.pkl',
...
def load_model_artifacts():
    ...
    ctx_cols     = joblib.load('context_columns.pkl')
...
joblib.dump(sarimax_exog_cols,          'context_columns.pkl')
print("✅ feature_columns.pkl, context_columns.pkl saved")
...
├── context_columns.pkl       ← the 11 SARIMAX exog column names
